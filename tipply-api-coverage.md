...
Czytelna macierz pokrycia aktualnego TypeScript SDK względem `openapi.json`.
...
- Buildery `tips` i `withdrawals` dodają obsługę query nad endpointami odczytu.

## Coverage

Poniżej każda sekcja ma własną tabelę, dzięki czemu status można łatwo aktualizować przy rozwoju SDK.

## user

| SDK | OpenAPI | Method | Path | Surface | Uwagi |
| --- | --- | --- | --- | --- | --- |
